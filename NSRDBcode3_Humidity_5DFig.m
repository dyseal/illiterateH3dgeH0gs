...
%%  %Creating avg daily Humidity array
    ...
    for j=1:length(avgdaily_solzen)
        avgdaily_solzen(j) = mean(NAD(a:b,14));
        a=a+24;
        b=b+24;
    end
...
%% Exploring Calculations and Plots for Humidity
...
% First we plot the moving mean over 24 hour windows for the year:
movy1 = movmean(LocAvgZenith,24);
% Then a plot of monthly window is made:
Mmovy1 = movmean(LocAvgZenith,24*7*4);
figure(3); clf
plot(TS,movy1,'linewidth',1)
hold on
plot(TS,Mmovy1,'linewidth',2)
hold on
title('Mean Humidity Over 1-year Period in Northwest US)')
ylabel('Humidity (%)')
xlabel('Time')
xlim([Begin End])
datetick('x',1)
...
% Then a plot of monthly window is made:
Mmovy2 = movmean(LocAvgZenith,24*7*4);
figure(3); clf
plot(TS,movy2,'linewidth',1)
hold on
plot(TS,Mmovy2,'linewidth',2)
hold on
title('Mean Humidity Over 1-year Period in Southeast US')
ylabel('Humidity (%)')
xlabel('Time')
xlim([Begin End])
datetick('x',1)
...
% Then a plot of monthly window is made:
Mmovy3 = movmean(LocAvgZenith,24*7*4);
figure(3); clf
plot(TS,movy3,'linewidth',1)
hold on
plot(TS,Mmovy3,'linewidth',2)
hold on
title('Mean Humidity Over 1-year Period in Northeast US')
ylabel('Humidity (%)')
xlabel('Time')
xlim([Begin End])
datetick('x',1)
...
% Then a plot of monthly window is made:
Mmovy4 = movmean(LocAvgZenith,24*7*4);
figure(3); clf
plot(TS,movy4,'linewidth',1)
hold on
plot(TS,Mmovy4,'linewidth',2)
hold on
title('Mean Humidity Over 1-year Period in Southern California US')
ylabel('Humidity (%)')
xlabel('Time')
xlim([Begin End])
datetick('x',1)
...
% Then a plot of monthly window is made:
Mmovy5 = movmean(LocAvgZenith,24*7*4);
figure(3); clf
plot(TS,movy5,'linewidth',1)
hold on
plot(TS,Mmovy5,'linewidth',2)
hold on
title('Mean Humidity Over 1-year Period in Central US')
ylabel('Humidity (%)')
xlabel('Time')
xlim([Begin End])
datetick('x',1)
...
% Then a plot of monthly window is made:
Mmovy6 = movmean(LocAvgZenith,24*7*4);
figure(3); clf
plot(TS,movy6,'linewidth',1)
hold on
plot(TS,Mmovy6,'linewidth',2)
hold on
title('Mean Humidity Over 1-year Period in South US')
ylabel('Humidity (%)')
xlabel('Time')
xlim([Begin End])
datetick('x',1)
...
% Then a plot of monthly window is made:
Mmovy7 = movmean(LocAvgZenith,24*7*4);
figure(3); clf
plot(TS,movy7,'linewidth',1)
hold on
plot(TS,Mmovy7,'linewidth',2)
hold on
title('Mean Humidity Over 1-year Period in Northern California')
ylabel('Humidity (%)')
xlabel('Time')
xlim([Begin End])
datetick('x',1)
...
plot(TS,Mmovy7,'linewidth',2)
hold on
title('Moving Mean Humidity Over 1-year Period')
ylabel('Humidity (%)')
xlabel('Time')
xlim([Begin End])
ylim([0 100])

...
%%  %Creating avg daily Dew Point array
    ...
    for j=1:length(avgdaily_solzen)
        avgdaily_solzen(j) = mean(NAD(a:b,11));
        a=a+24;
        b=b+24;
    end
...
%% Exploring Calculations and Plots for Dew Point
...
hold on
title('Mean Dew Point Over 1-year Period in Northwest US)')
ylabel('Dew Point (°C)')
xlabel('Time')
xlim([Begin End])
datetick('x',1)
...
hold on
title('Mean Dew Point Over 1-year Period in Southeast US')
ylabel('Dew Point (°C)')
xlabel('Time')
xlim([Begin End])
datetick('x',1)
...
hold on
title('Mean Dew Point Over 1-year Period in Northeast US')
ylabel('Dew Point (°C)')
xlabel('Time')
xlim([Begin End])
datetick('x',1)
...
hold on
title('Mean Dew Point Over 1-year Period in Southern California US')
ylabel('Dew Point (°C)')
xlabel('Time')
xlim([Begin End])
datetick('x',1)
...
hold on
title('Mean Dew Point Over 1-year Period in Central US')
ylabel('Dew Point (°C)')
xlabel('Time')
xlim([Begin End])
datetick('x',1)
...
hold on
title('Mean Dew Point Over 1-year Period in South US')
ylabel('Dew Point (°C)')
xlabel('Time')
xlim([Begin End])
datetick('x',1)
...
hold on
title('Mean Dew Point Over 1-year Period in Northern California')
ylabel('Dew Point (°C)')
xlabel('Time')
xlim([Begin End])
datetick('x',1)
...
plot(TS,Mmovy7,'linewidth',2)
hold on
title('Moving Mean Dew Point Over 1-year Period')
ylabel('Dew Point (°C)')
xlabel('Time')
xlim([Begin End])
ylim([-10 40])
legend('Northwest', 'Southeast', 'Northeast', 'California(S)', 'Central', 'Southern', 'California(N)', 'Location', 'northwest')
datetick('x',1)
ax = gca;
ax.FontSize = 18;
grid on

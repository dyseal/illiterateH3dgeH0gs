...
%% Calc and plot for NW Humidity
%Location 1 = Northwest US
NAD_forNW = NAD(indNWrevis,:);

YrLength=YrEnd(1);
LocAvgHumidity = NaN(YrLength(1),1);
for j=1:YrLength(1);
k = [j:YrLength:length(NAD_forNW)]';
l = NAD_forNW(k,:);
LocAvgHumidity(j)= mean(l(:,14));
end 

LocMovHumidity = mean(LocAvgHumidity);
y1 = LocAvgHumidity;
figure(2); clf
plot(TS,y1)
hold on
datetick('x',6)
title('Mean Hourly Humidity Over 1-year Period (2020) in Northwest US')
ylabel('Humidity (%)')
xlabel('Time')
%xlim([Begin End])
datetick('x',6)
...
movy1 = movmean(LocAvgHumidity,24);
figure(3); clf
subplot(2,1,1)
plot(TS,movy1)
hold on
title('Daily Mean Humidity Over 1-year Period (2020) in Northwest US')
ylabel('Humidity (%)')
xlabel('Time')
%xlim([Begin End])
datetick('x',6)
...
movy1 = movmean(LocAvgHumidity,(24*7));
figure(16); clf
subplot(2,1,1)
plot(TS,movy1)
hold on
title('Daily Mean Humidity Over 1-year Period (2020) in Southern California US')
ylabel('Humidity (%)')
xlabel('Time')
%xlim([Begin End])
datetick('x',6)
...
plot(TS,y2)
hold on
title('Mean Hourly Humidity Over 1-year Period (2020) in Northeast US')
ylabel('Humidity (%)')
xlabel('Time')
%xlim([Begin End])
datetick('x',6)
...
movy2 = movmean(LocAvgHumidity,24*7);
figure(5); clf
subplot(2,1,1)
plot(TS,movy2)
hold on
title('Daily Mean Humidity Over 1-year Period (2020) in Northeast US')
ylabel('Humidity (%)')
xlabel('Time')
%xlim([Begin End])
datetick('x',6)
...
plot(TS,y3)
hold on
title('Mean Hourly Humidity Over 1-year Period (2020) in Central US')
ylabel('Humidity (%)')
xlabel('Time')
%xlim([Begin End])
datetick('x',6)
...
movy3 = movmean(LocAvgHumidity,24*7);
figure(7); clf
subplot(2,1,1)
plot(TS,movy3)
hold on
title('Daily Mean Humidity Over 1-year Period (2020) in Central US')
ylabel('Humidity (%)')
xlabel('Time')
%xlim([Begin End])
datetick('x',6)
...
plot(TS,y4)
hold on
title('Mean Hourly Humidity Over 1-year Period (2020) in Southeast US')
ylabel('Humidity (%)')
xlabel('Time')
%xlim([Begin End])
datetick('x',6)
...
movy4 = movmean(LocAvgHumidity,24*7);
figure(9); clf
subplot(2,1,1)
plot(TS,movy4)
hold on
title('Daily Mean Humidity Over 1-year Period (2020) in Southeast US')
ylabel('Humidity (%)')
xlabel('Time')
%xlim([Begin End])
datetick('x',6)
...
plot(TS,y5)
hold on
title('Mean Hourly Humidity Over 1-year Period (2020) in South US')
ylabel('Humidity (%)')
xlabel('Time')
%xlim([Begin End])
datetick('x',6)
...
movy5 = movmean(LocAvgHumidity,24*7);
figure(11); clf
subplot(2,1,1)
plot(TS,movy5)
hold on
title('Daily Mean Humidity Over 1-year Period (2020) in South US')
ylabel('Humidity (%)')
xlabel('Time')
%xlim([Begin End])
datetick('x',6)
...
%% Calc and plot for North CA Humidity
%Location 6 = N CA US
...
plot(TS,y6)
hold on
title('Mean Hourly Humidity Over 1-year Period (2020) in Northern California')
ylabel('Humidity (%)')
xlabel('Time')
%xlim([Begin End])
datetick('x',6)
...
movy6 = movmean(LocAvgHumidity,24*7);
figure(13); clf
subplot(2,1,1)
plot(TS,movy6)
hold on
title('Daily Mean Humidity Over 1-year Period (2020) in Northern California US')
ylabel('Humidity (%)')
xlabel('Time')
%xlim([Begin End])
datetick('x',6)
...
%% Calc and plot for SCA Humidity
%Location 7 = SCA US
...
plot(TS,y7)
hold on
title('Mean Hourly Humidity Over 1-year Period (2020) in Southern California')
ylabel('Humidity (%)')
xlabel('Time')
%xlim([Begin End])
datetick('x',6)
...
movy7 = movmean(LocAvgHumidity,24*7);
figure(15); clf
subplot(2,1,1)
plot(TS,movy7)
hold on
...
plot(TS,movy7,'-',TS,f2,'-')
hold on
legend('Humidity data','Polynomial fit')
hold off
